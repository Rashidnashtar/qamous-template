...
const SecondListingThumbnail = () => {
  return (
    <div className="listing-todo-thumbnail-area style-two">
      <div
        className="todo-thumb bg-image bg-overlay"
        style={{
          backgroundImage: "url(assets/images/todo/single/2/1.jpg)",
        }}
      />
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <div className="listing-todo-content text-white">
                <div className="content-left">
                  ...
                  <div className="info">
                    <h3 className="title">El Patros Barcelo Hotel</h3>
...
export default SecondListingThumbnail;
