...
const FifthPopularTodos = () => {
  return (
    <section className="popular-todos-section popular-todos-style-two ptb-100">
          ...
          <div className="col-lg-8">
            <div className="section-header">
              <h2 className="section-title">
                Top rated <span>Experiences</span>
              </h2>
      ...
      {/*~./ end todo items carousel ~*/}
    </section>
  );
};

export default FifthPopularTodos;
